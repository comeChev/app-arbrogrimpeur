...
const ModalImage = ({ img, text, alt, setIsOpen }) => {
  return (
    <div class="fixed bg-gray-600 bg-opacity-50 top-0 left-0 z-[1055] h-full w-full overflow-y-auto outline-none transition duration-700">
      <div class="relative top-2 h-[90%] mx-auto p-5 border w-3/4 shadow-lg rounded-md bg-gradient-to-r from-emerald-50 to-teal-100 ">
