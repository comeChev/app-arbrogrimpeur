...
const ModalHours = ({ setIsOpen }) => {
  return (
    <AnimatePresence mode="popLayout">
      <div
        class="fixed bg-gray-600 bg-opacity-50 top-0 left-0 z-[1055] h-full w-full overflow-y-auto outline-none"
        id="openingHoursModal"
      >
        <motion.div
          class="relative top-20 mx-auto p-5 border w-[80%] sm:w-96 shadow-lg rounded-md bg-gradient-to-r from-emerald-50 to-teal-100"
